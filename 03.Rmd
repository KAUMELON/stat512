...
Estimated value of *c* is -0.3952. Therefore, computed value of b =
0.3952. In our case
$\text{}\frac{x_{1}}{n} = \frac{1}{150} = 0.0067$, computed value of
*b* is 0.3952. Now we need to find the adjusted value as explained in
step-6 in section \@ref(smith) using the table below. Now the rounded
value of b is 40 and the value of
$\frac{x_{1}}{n} = \frac{1}{150} = 0.0067$ is between 0.001 and 0.01,
the adjusted value of b is 0.443.
